...
export const translations = {
  en: {
    ...
    cookies: {
      ...
      message: 'We\'d like to collect your email to stay in touch about 4S updates and opportunities. Your privacy is important to us.',
      accept: 'Accept & Subscribe',
      decline: 'Decline',
      successMessage: 'Thank you! We\'ve saved your email.',
    },
    language: 'Language',
  },
  fr: {
    ...
    cookies: {
      ...
      message: 'Nous aimerions collecter votre email pour rester en contact au sujet des mises à jour et opportunités de 4S. Votre confidentialité est importante pour nous.',
      accept: 'Accepter et S\'abonner',
      decline: 'Refuser',
      successMessage: 'Merci! Nous avons sauvegardé votre email.',
    },
    language: 'Langue',
  },
};
