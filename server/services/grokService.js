...
exports.grokService = exports.GrokService = void 0;
...
const XAI_API_KEY = process.env.VITE_XAI_API_KEY ??
    ...
    "";
if (!XAI_API_KEY) {
    console.warn("[grokService] Missing XAI API key. Set XAI_API_KEY or VITE_XAI_API_KEY in your environment.");
}
class GrokService {
    constructor() {
        this.openai = null;
...
Be professional, optimistic, and impact-focused.`;
    ...
    async getFallbackResponse(userMessage, language = 'en') {
...
What would you like help with? Ask me to calculate impact, match solutions, analyze ROI, or discuss partnerships!`;
    ...
    async chatWithContext(userMessage, language = 'en') {
